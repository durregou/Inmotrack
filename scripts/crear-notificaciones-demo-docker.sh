...
# Script para crear notificaciones de demostración usando Docker
# Usuario: Maria Inquilina (ID: 7)
...
VALUES (
    ...
    'Tu solicitud de mantenimiento ha sido recibida y está siendo procesada. El propietario ha sido notificado.',
    'SISTEMA',
    'ENVIADO',
    NOW() - INTERVAL '2 days',
    'MEDIA'
...
if [ $? -eq 0 ]; then
    ...
    echo "   Verifica que el contenedor 'microservicios-postgres-db-1' esté corriendo"
    echo ""
fi
